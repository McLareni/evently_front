...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'bg-gradient': 'linear-gradient(123deg, rgba(155, 143, 243, 0.80) 0%, rgba(56, 246, 249, 0.80) 100%)',
        ...
        'eventDetails': 'linear-gradient(123deg, rgba(155, 143, 243, 0.80) 0%, rgba(56, 246, 249, 0.80) 100%)',
      },
      gridTemplateColumns: {
