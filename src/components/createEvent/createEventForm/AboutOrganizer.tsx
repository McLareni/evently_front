...
const AboutOrganizer: React.FC<AboutOrganizerProps> = ({
  ...
  return (
    <div
      ...
      className={clsx(
        'relative lg:w-[760px] w-full rounded-[20px] lg:border-2 border border-buttonPurple p-3 lg:py-8 lg:px-8'
      )}
    >
      {isMobile && (
        <MobileSectionHeader
      ...
      >
        <div className="flex flex-col relative mt-3 lg:mt-0">
          <label
        ...
        <label className="flex items-center cursor-pointer lg:text-base text-sm">
          <input
            id="unlimitedTickets"
            type="checkbox"
