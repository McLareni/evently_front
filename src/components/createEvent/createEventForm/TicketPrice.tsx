...
const TicketPrice: React.FC<TicketPriceProps> = ({price, onPriceChange}) => {
    ...
    useEffect(() => {
      ...
      } else if (!freeTickets && price) {
        onPriceChange(price);  // Передаємо актуальну ціну для платних квитків
      }
        ...
        <div className="flex">
          <div className="flex flex-col">
            ...
            <input
              id="price"
              type="number"
              className={`border-2 w-[240px] h-[48px] my-[2px] mx-[2px] p-4 rounded-[10px] mr-4 [appearance:textfield]  [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              <HiOutlineTicket className="absolute top-[15.25px] left-[17.25px] w-6 h-6" />
                ...
                <input
                  type="number"
                  className="border-2 border-buttonPurple pl-[49px] w-[240px] h-[48px] my-[2px] mx-[2px] p-4 rounded-[10px] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none 
