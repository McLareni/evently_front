...
const AboutEvent: React.FC<AboutEventProps> = ({
  ...
  return (
    <div
      className={clsx(
        'relative lg:w-[760px] w-full rounded-[20px] lg:border-2 border border-buttonPurple p-3 lg:py-8 ' +
          'lg:px-8 lg:mb-8 mb-4'
      )}
    >
      {isMobile && (
        <MobileSectionHeader
      ...
      >
        <div className="flex flex-col lg:pb-2 pb-0 mt-3 lg:mt-0">
        ...
        <div>
          <div className="flex flex-col">
            ...
            <Controller
              ...
              control={control}
              render={() => (
                <div className="flex break-words lg:w-[669px] w-full h-auto flex-wrap">
