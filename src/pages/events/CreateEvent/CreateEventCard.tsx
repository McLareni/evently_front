...
import exampleCard from '../../../../public/images/exampleCard.svg'
...
const CreateEventCard: React.FC<CardProps>= ({ eventName, price}) => {
    ...
    <div className=' sticky group relative flex overflow-hidden items-start rounded-[20px] shadow-eventCardShadow max-h-[514px] max-w-[312px] w-[312px] h-[514px] top-[150px] mr-[135px]'>
        ...
        <div className='absolute flex flex-col items-start gap-2 justify-between w-full py-4 px-5 h-[365px]
          rounded-t-[20px] bg-background transition-all ease-in-out duration-300 -bottom-[70px]
          group-hover:-bottom-0
          '>
            <div className='flex items-center justify-center h-8 rounded-[20px]
                 border-[2px] border-borderColor bg-bg-gradient'>
                <p className='font-normal text-md text-textDark px-4 py-2.5'>Категорія</p>
            </div>
            <h2 className="min-h-[72px] text-2xl text-textDark group-hover:line-clamp-none">{eventName}</h2>
